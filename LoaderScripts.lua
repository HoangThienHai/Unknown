...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Script Cực Cháy🔥🔥🔥<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Monkey Hub Siêu OP!!!!<Color=/>"):Display()
    wait(.14)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Trigon is better than Fluxus.<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Channel : Hoàng Thiên Hải <Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Monkey Hub", HidePremium = false, IntroText = "Orion Library", SaveConfig = true, ConfigFolder = "Monkey Hub"})
...
OrionLib:MakeNotification({
	Name = "Monkey Hub",
	Content = "Monkey Hub is Very Super OP",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
W:AddLabel("Script By Hoàng Thiên Hải")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] Hoàng Thiên Hải!")
